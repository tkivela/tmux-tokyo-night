...
function generate_inactive_window_string() {
  ...
  echo "${separator_start}#[fg=${PALLETE[white]}]#I${separator_internal}#[fg=${PALLETE[white]}]#{?window_zoomed_flag,$zoomed_window_icon, ""}#W ${separator_end}"
}
...
function generate_active_window_string() {
  ...
  echo "${separator_start}#[fg=${PALLETE[white]}]#I${separator_internal}#[fg=${PALLETE[white]}]#{?window_zoomed_flag,$zoomed_window_icon, ""}#W #{?pane_synchronized,$pane_synchronized_icon, }${separator_end}#[none]"
}
